			...
			<>
				...
				<div className="page-content">
					<div className="overlay-black-dark profile-edit p-t50 p-b20" style={{ backgroundImage: "url(" + bnr + ")" }}>
						...
						<div className="modal fade browse-job modal-bx-info editor" id="profilename" tabIndex="-1" role="dialog" aria-labelledby="ProfilenameModalLongTitle" aria-hidden="true">
									...
									<div className="col-xl-9 col-lg-8 col-md-8 col-sm-12">
										<div id="resume_headline_bx" className=" job-bx bg-white m-b30">
											<div className="d-flex">
												...
												<Link to={"#"} data-toggle="modal" data-target="#resumeheadline" className="site-button add-btn button-sm" onClick={this.handleShow}>
													<i className="fa fa-pencil m-r5"></i> Edit
												</Link>
											</div>
											<p className="m-b0">Job board currently living in USA</p>

											<Modal show={this.state.show} onHide={this.handleClose} className="modal fade modal-bx-info editor" id="resumeheadline" tabIndex="-1" role="dialog" aria-labelledby="ResumeheadlineModalLongTitle" aria-hidden="true">
												<div className="modal-dialog my-0" role="document">
													<div className="modal-content">
														...
														<div className="modal-footer">
															<button type="button" className="site-button" data-dismiss="modal" onClick={this.handleClose}>Cancel</button>
															<button type="button" className="site-button">Save</button>
														</div>
													</div>
												</div>
										...
										<div id="key_skills_bx" className="job-bx bg-white m-b30">
											<div className="d-flex">
												...
												<Link to={"#"} data-toggle="modal" data-target="#keyskills" onClick={this.handleShow} className="site-button add-btn button-sm"><i className="fa fa-pencil m-r5"></i> Edit</Link>
											</div>
											...
											<div className="modal fade modal-bx-info editor" id="keyskills" tabIndex="-1" role="dialog" aria-labelledby="KeyskillsModalLongTitle" aria-hidden="true">
												<div className="modal-dialog " role="document">
													<div className="modal-content">
														<div className="modal-header">
										...
										<div id="employment_bx" className="job-bx bg-white m-b30 ">
											<div className="d-flex">
												...
												<Link to={"#"} data-toggle="modal" data-target="#employment" onClick={this.handleShow} className="site-button add-btn button-sm"><i className="fa fa-pencil m-r5"></i> Edit</Link>
											</div>
											...
											<Modal show={this.state.show} onHide={this.handleClose} className="modal fade modal-bx-info editor" id="employment" tabIndex="-1" role="dialog" aria-labelledby="EmploymentModalLongTitle" aria-hidden="true">
												<div className="modal-dialog my-0" role="document">
													<div className="modal-content">
														<div className="modal-header">
										...
										<div id="education_bx" className="job-bx bg-white m-b30">
											<div className="d-flex">
												...
												<Link to={"#"} data-toggle="modal" data-target="#education" onClick={this.handleShow} className="site-button add-btn button-sm"><i className="fa fa-pencil m-r5"></i> Edit</Link>
											</div>
											<p>Mention your employment details including your current and previous company work experience</p>

											<div className="modal fade modal-bx-info editor" id="education" tabIndex="-1" role="dialog" aria-labelledby="EducationModalLongTitle" aria-hidden="true">
												<div className="modal-dialog my-0" role="document">
													<div className="modal-content">
														<div className="modal-header">
										...
										<div id="it_skills_bx" className="job-bx table-job-bx bg-white m-b30">
											<div className="d-flex">
												...
												<Link to={"#"} data-toggle="modal" data-target="#itskills" onClick={this.handleShow} className="site-button add-btn button-sm"><i className="fa fa-pencil m-r5"></i> Edit</Link>
											</div>
											<p>Mention your employment details including your current and previous company work experience</p>
											<table>
												<thead>
											...
											<div className="modal fade modal-bx-info editor" id="itskills" tabIndex="-1" role="dialog" aria-labelledby="ItskillsModalLongTitle" aria-hidden="true">
												<div className="modal-dialog" role="document">
													<div className="modal-content">
														<div className="modal-header">
										...
										<div id="projects_bx" className="job-bx bg-white m-b30">
											<div className="d-flex">
												...
												<Link to={"#"} data-toggle="modal" data-target="#projects" onClick={this.handleShow} className="site-button add-btn button-sm"><i className="fa fa-pencil m-r5"></i> Edit</Link>
											</div>
										...
										<div id="profile_summary_bx" className="job-bx bg-white m-b30">
											<div className="d-flex">
												...
												<Link to={"#"} data-toggle="modal" data-target="#profilesummary" onClick={this.handleShow} className="site-button add-btn button-sm"><i className="fa fa-pencil m-r5"></i> Edit</Link>
											</div>
											...
											<div className="modal fade modal-bx-info editor" id="profilesummary" tabIndex="-1" role="dialog" aria-labelledby="ProfilesummaryModalLongTitle" aria-hidden="true">
												<div className="modal-dialog" role="document">
													<div className="modal-content">
														<div className="modal-header">
										...
										<div id="accomplishments_bx" className="job-bx bg-white m-b30">
											...
											<div className="list-row">
												<div className="list-line">
													<div className="d-flex">
														...
														<Link to={"#"} data-toggle="modal" data-target="#accomplishments" onClick={this.handleShow} className="site-button add-btn button-sm"><i className="fa fa-pencil m-r5"></i> Edit</Link>
													</div>
													<p className="m-b0">Add link to Online profiles (e.g. Linkedin, Facebook etc.).</p>

													<div className="modal fade modal-bx-info editor" id="accomplishments" tabIndex="-1" role="dialog" aria-labelledby="AccomplishmentsModalLongTitle" aria-hidden="true">
														<div className="modal-dialog" role="document">
															<div className="modal-content">
																<div className="modal-header">
													...
													<div className="list-line">
														<div className="d-flex">
															...
															<Link to={"#"} data-toggle="modal" data-target="#worksample" onClick={this.handleShow} className="site-button add-btn button-sm"><i className="fa fa-pencil m-r5"></i> Edit</Link>
														</div>
														<p className="m-b0">Add link to your Projects (e.g. Github links etc.).</p>

														<div className="modal fade modal-bx-info editor" id="worksample" tabIndex="-1" role="dialog" aria-labelledby="WorksampleModalLongTitle" aria-hidden="true">
															<div className="modal-dialog" role="document">
																<div className="modal-content">
																	<div className="modal-header">
													...
													<div className="list-line">
														<div className="d-flex">
															...
															<Link to={"#"} data-toggle="modal" data-target="#journalentry" onClick={this.handleShow} className="site-button add-btn button-sm"><i className="fa fa-pencil m-r5"></i> Edit</Link>
														</div>
														<p className="m-b0">Add links to your Online publications.</p>

														<div className="modal fade modal-bx-info editor" id="journalentry" tabIndex="-1" role="dialog" aria-labelledby="JournalentryModalLongTitle" aria-hidden="true">
															<div className="modal-dialog" role="document">
																<div className="modal-content">
																	<div className="modal-header">
													...
													<div className="list-line">
														<div className="d-flex">
															...
															<Link to={"#"} data-toggle="modal" data-target="#presentation" onClick={this.handleShow} className="site-button add-btn button-sm"><i className="fa fa-pencil m-r5"></i> Edit</Link>
														</div>
														<p className="m-b0">Add links to your Online presentations (e.g. Slideshare presentation links etc.).</p>

														<div className="modal fade modal-bx-info editor" id="presentation" tabIndex="-1" role="dialog" aria-labelledby="PresentationModalLongTitle" aria-hidden="true">
															<div className="modal-dialog" role="document">
																<div className="modal-content">
																	<div className="modal-header">
													...
													<div className="list-line">
														<div className="d-flex">
															...
															<Link to={"#"} data-toggle="modal" data-target="#patent" onClick={this.handleShow} className="site-button add-btn button-sm"><i className="fa fa-pencil m-r5"></i> Edit</Link>
														</div>
														<p className="m-b0">Add details of Patents you have filed.</p>

														<div className="modal fade modal-bx-info editor" id="patent" tabIndex="-1" role="dialog" aria-labelledby="PatentModalLongTitle" aria-hidden="true">
															<div className="modal-dialog" role="document">
																<div className="modal-content">
																	<div className="modal-header">
													...
													<div className="list-line">
														<div className="d-flex">
															...
															<Link to={"#"} data-toggle="modal" data-target="#certification" onClick={this.handleShow} className="site-button add-btn button-sm"><i className="fa fa-pencil m-r5"></i> Edit</Link>
														</div>
														<p className="m-b0">Add details of Certification you have filed.</p>

														<div className="modal fade modal-bx-info editor" id="certification" tabIndex="-1" role="dialog" aria-labelledby="CertificationModalLongTitle" aria-hidden="true">
															<div className="modal-dialog" role="document">
																<div className="modal-content">
																	<div className="modal-header">
											...
											<div id="desired_career_profile_bx" className="job-bx bg-white m-b30">
												<div className="d-flex">
													...
													<Link to={"#"} data-toggle="modal" data-target="#desiredprofile" onClick={this.handleShow} className="site-button add-btn button-sm"><i className="fa fa-pencil m-r5"></i> Edit</Link>
												</div>

												<div className="modal fade modal-bx-info editor" id="desiredprofile" tabIndex="-1" role="dialog" aria-labelledby="DesiredprofileModalLongTitle" aria-hidden="true">
													<div className="modal-dialog" role="document">
														<div className="modal-content">
															<div className="modal-header">
											...
											<div id="personal_details_bx" className="job-bx bg-white m-b30">
												<div className="d-flex">
													...
													<Link to={"#"} data-toggle="modal" data-target="#personaldetails" onClick={this.handleShow} className="site-button add-btn button-sm"><i className="fa fa-pencil m-r5"></i> Edit</Link>
												</div>

												<div className="modal fade modal-bx-info editor" id="personaldetails" tabIndex="-1" role="dialog" aria-labelledby="PersonaldetailsModalLongTitle" aria-hidden="true">
													<div className="modal-dialog" role="document">
														<div className="modal-content">
															<div className="modal-header">
